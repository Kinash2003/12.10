...
int main()
{
	...
	do {
		...
		{
		case 1:
			cout << "Введіть кількість: "; cin >> kilkist;
			cout << endl;
		...
		case 2:
			...
			break;
		case 3:
			cout << "Введіть кількість  щоб добавити до даного дерева: "; cin >> N;
			for (int i = 0; i < N; i++)
			{
				cout << "Введіть значення №" << i + 1 << ": "; cin >> value;
		...
		case 4:
			...
			break;
		case 5:
			cout << "Введіть значення  для вилучення: "; cin >> value;
			node = BinarySearchDelete(node, value, level);
			break;
		case 6:
			cout << "Введіть значення для пошуку: "; cin >> value;
			b = false;
			Find_vyzol(node, value, b);

			if (b)
				cout << "Введене знайшлося: ";
			else
				cout << "Введене не знайшлося: ";
			break;
		case 7:
			PrintTree1(node, 0);
			break;
